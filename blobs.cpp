...
int main()
{
	...
	cv::Mat image= cv::imread("/home/bernard/pics/1.jpg",0);
	if (!image.data)
		return 0; 
	...
	cv::Mat original= cv::imread("/home/bernard/pics/1.jpg");
	...
	image= cv::imread("/home/bernard/pics/1.jpg",0);
...
//	cv::convexityDefects(contours[3], hull, defects);
	...
	image= cv::imread("/home/bernard/pics/430.jpg",0);
